...
class supermen: public ::xml_schema::type
{
  public:
  // person
  // 
...
supermen_ (const ::std::string& uri,
           ::xml_schema::flags f = 0,
...
::std::auto_ptr< ::supermen >
supermen_ (::xercesc::InputSource& is,
           ::xml_schema::flags f = 0,
           const ::xml_schema::properties& p = ::xml_schema::properties ());
...
void
operator<< (::xercesc::DOMElement&, const superman&);

void
operator<< (::xercesc::DOMElement&, const batman&);

void
operator<< (::xercesc::DOMElement&, const supermen&);

// Serialize to std::ostream.
//

void
supermen_ (::std::ostream& os,
           const ::supermen& x, 
...
void
supermen_ (::xercesc::XMLFormatTarget& ft,
           const ::supermen& x, 
           const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
           const ::std::string& e = "UTF-8",
           ::xml_schema::flags f = 0);
