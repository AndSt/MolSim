...
namespace protocol
{
  ...
  class balance_t: public ::protocol::request_t
  {
    public:
    // Constructors.
    //
  ...
  class withdraw_t: public ::protocol::request_t
  {
    public:
    // amount
    // 
  ...
  class deposit_t: public ::protocol::request_t
  {
    public:
    // amount
    // 
...
namespace protocol
{
  ...
  ::std::auto_ptr< ::protocol::balance_t >
  balance (::xercesc::InputSource& is,
           ::xml_schema::flags f = 0,
           const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  ::std::auto_ptr< ::protocol::withdraw_t >
  withdraw (::xercesc::InputSource& is,
            ::xml_schema::flags f = 0,
            const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  ::std::auto_ptr< ::protocol::deposit_t >
  deposit (::xercesc::InputSource& is,
           ::xml_schema::flags f = 0,
           const ::xml_schema::properties& p = ::xml_schema::properties ());
