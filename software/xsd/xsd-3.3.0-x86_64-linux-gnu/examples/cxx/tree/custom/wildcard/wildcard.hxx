...
namespace wildcard
{
  class data_base: public ::xml_schema::string
  {
    public:
    // id
    // 
    ...
    data_base (const char*);

    data_base (const ::std::string&);

    data_base (const ::xml_schema::string&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const data_base&);
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const data_base&);
  ...
  data_ (const ::wildcard::data& x, 
         const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
         ::xml_schema::flags f = 0);
}

#ifndef XSD_DONT_INCLUDE_INLINE
#include "wildcard.ixx"
#endif // XSD_DONT_INCLUDE_INLINE
