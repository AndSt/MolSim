...
namespace contacts
{
  ...
  contact_base::
  contact_base (const name_type& name,
                const email_type& email,
                const phone_type& phone)
  : ::xml_schema::type (),
    name_ (name, ::xml_schema::flags (), this),
    email_ (email, ::xml_schema::flags (), this),
    phone_ (phone, ::xml_schema::flags (), this)
  {
  }

  contact_base::
  contact_base (const contact_base& x,
                ::xml_schema::flags f,
  ...
  contact_base::
  contact_base (const ::xercesc::DOMElement& e,
                ::xml_schema::flags f,
                ::xml_schema::container* c)
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // email
      //
      if (n.name () == "email" && n.namespace_ ().empty ())
      {
  ...
  {
    return new class contact_base (*this, f, c);
  }
...
namespace contacts
{
            ...
            const ::xml_schema::properties& p)
  {
    ...
    ::std::auto_ptr< ::contacts::catalog > r (
      ::contacts::catalog_ (
            ...
            const ::xml_schema::properties& p)
  {
    ...
    return ::contacts::catalog_ (isrc, f, p);
  }
            ...
            const ::xml_schema::properties& p)
  {
    ...
    ::xsd::cxx::xml::sax::std_input_source isrc (is);
    return ::contacts::catalog_ (isrc, h, f, p);
  }
            ...
            const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == "catalog" &&
        n.namespace_ () == "http://www.codesynthesis.com/contacts")
    {
      ::std::auto_ptr< ::contacts::catalog > r (
        ::xsd::cxx::tree::traits< ::contacts::catalog, char >::create (
          e, f, 0));
      return r;
    }
    ...
    throw ::xsd::cxx::tree::unexpected_element < char > (
      ...
      n.namespace_ (),
      "catalog",
      "http://www.codesynthesis.com/contacts");
  }
