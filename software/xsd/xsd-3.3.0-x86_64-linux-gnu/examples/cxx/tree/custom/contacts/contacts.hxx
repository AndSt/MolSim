...
namespace contacts
{
  class contact_base: public ::xml_schema::type
  {
    public:
    // name
    // 
    ...
    void
    phone (::std::auto_ptr< phone_type > p);

    // Constructors.
    //
    contact_base (const name_type&,
                  const email_type&,
                  const phone_type&);
    ...
    ::xsd::cxx::tree::one< phone_type > phone_;
  };
  ...
  class catalog: public ::xml_schema::type
  {
    ...
    // contact
    // 
    typedef ::contacts::contact contact_type;
