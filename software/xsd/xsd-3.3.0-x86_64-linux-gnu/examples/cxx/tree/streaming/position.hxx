...
namespace op
{
  ...
  class object: public ::xml_schema::type
  {
    ...
    // position
    // 
    typedef ::op::position position_type;
    ...
    // Constructors.
    //
    object (const header_type&,
            const id_type&);

    object (::std::auto_ptr< header_type >&,
            const id_type&);
