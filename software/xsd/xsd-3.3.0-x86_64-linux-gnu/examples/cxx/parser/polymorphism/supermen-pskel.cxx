...
void supermen_pskel::
person_parser (const ::xml_schema::parser_map& m)
{
  this->person_parser_map_ = &m;
}
...
// Substitution map entry for superman.
//
static
const ::xsd::cxx::parser::substitution_map_entry< char >
_xsd_superman_substitution_map_entry_ (
  "",
  "superman",
  "",
  "person",
  ::superman_pskel::_static_type ());
                     ...
                     const ::xml_schema::ro_string* t)
{
  ...
  if ((n == "person" && ns.empty ()) ||
      ::xsd::cxx::parser::substitution_map_instance< char > ().check (
        ns, n, "", "person", t))
  {
    if (t == 0 && this->person_parser_ != 0)
      this->person_parser_cache_ = this->person_parser_;
    else
    {
      ::xml_schema::ro_string ts (::person_pskel::_static_type (), 6UL);

      if (t == 0)
        t = &ts;

      if (this->person_parser_ != 0 && *t == ts)
        this->person_parser_cache_ = this->person_parser_;
      else if (this->person_parser_map_ != 0)
        this->person_parser_cache_ = dynamic_cast< ::person_pskel* > (
          this->person_parser_map_->find (*t));
      else
        this->person_parser_cache_ = 0;
    }

    this->::xml_schema::complex_content::context_.top ().parser_ = this->person_parser_cache_;

    if (this->person_parser_cache_)
      this->person_parser_cache_->pre ();
                   ...
                   const ::xml_schema::ro_string& n)
{
        ...
        ns, n, "", "person"))
  {
    if (this->person_parser_cache_)
    {
      this->person_parser_cache_->post_person ();
      this->person ();
    }
