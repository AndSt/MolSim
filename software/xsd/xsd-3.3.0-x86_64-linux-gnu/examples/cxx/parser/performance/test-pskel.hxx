...
#ifndef TEST_PSKEL_HXX
#define TEST_PSKEL_HXX
...
namespace test
{
  class enum_pskel: public virtual ::xml_schema::string_pskel
  {
    public:
  ...
  class record_pskel: public ::xml_schema::complex_content
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
    ...
    //
    void
    int_parser (::xml_schema::unsigned_int_pskel&);
    ...
    void
    choice1_parser (::xml_schema::string_pskel&);

    void
    choice2_parser (::xml_schema::string_pskel&);

    void
    choice3_parser (::xml_schema::string_pskel&);

    void
    choice4_parser (::xml_schema::string_pskel&);

    void
    enum_parser (::test::enum_pskel&);

    void
    apple_parser (::xml_schema::boolean_pskel&);

    void
    orange_parser (::xml_schema::unsigned_long_pskel&);

    void
    parsers (::xml_schema::unsigned_int_pskel& /* int */,
    ...
    protected:
    ::xml_schema::unsigned_int_pskel* int__parser_;
    ::xml_schema::double_pskel* double__parser_;
    ::xml_schema::ncname_pskel* name_parser_;
    ::xml_schema::string_pskel* string_parser_;
    ::xml_schema::string_pskel* choice1_parser_;
    ::xml_schema::string_pskel* choice2_parser_;
    ::xml_schema::string_pskel* choice3_parser_;
    ::xml_schema::string_pskel* choice4_parser_;
    ::test::enum_pskel* enum__parser_;
    ::xml_schema::boolean_pskel* apple_parser_;
    ::xml_schema::unsigned_long_pskel* orange_parser_;
  };

  class root_pskel: public ::xml_schema::complex_content
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
    ...
    //
    void
    record_parser (::test::record_pskel&);
    ...
    protected:
    ::test::record_pskel* record_parser_;
  };
}
