...
#ifndef EMAIL_PSKEL_HXX
#define EMAIL_PSKEL_HXX
...
namespace email
{
  class binary_pskel: public virtual ::xml_schema::base64_binary_pskel
  {
    public:
    ...
    void
    mime_parser (::xml_schema::string_pskel&);
    ...
    ::xml_schema::string_pskel* mime_parser_;
  };

  class envelope_pskel: public ::xml_schema::complex_content
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
    ...
    //
    void
    to_parser (::xml_schema::string_pskel&);

    void
    from_parser (::xml_schema::string_pskel&);

    void
    subject_parser (::xml_schema::string_pskel&);
    ...
    protected:
    ::xml_schema::string_pskel* to_parser_;
    ::xml_schema::string_pskel* from_parser_;
    ::xml_schema::string_pskel* subject_parser_;
  };
}
