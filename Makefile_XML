...
INP_SET_XML = "input/InputSetting.xml"
INP_SET_XSD = "input/InputSetting.xsd"
INP_PAR_XML = "input/InputParticles.xml"
INP_PAR_XSD = "input/InputParticles.xsd"
INP_CUB_XML = "input/InputCuboids.xml"
INP_CUB_XSD = "input/InputCuboids.xsd"
INP_SPH_XML = "input/InputSpheres.xml"
INP_SPH_XSD = "input/InputSpheres.xsd"
